...
public class ApproveAccommodationPageViewModel extends ViewModel {
    ...
    public void loadAccommodations() {
        Call<HashSet<AccommodationCardRDTO>> call = ClientUtils.accommodationService.getNotApprovedAccommodations();
