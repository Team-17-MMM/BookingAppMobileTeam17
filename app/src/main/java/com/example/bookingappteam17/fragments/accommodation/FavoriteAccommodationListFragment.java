...
public class FavoriteAccommodationListFragment extends ListFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FavoriteAccommodationPageViewModel viewModel = new ViewModelProvider(this).get(FavoriteAccommodationPageViewModel.class);
        ...
        viewModel.loadAccommodations(sharedPreferences.getString("username", ""),sharedPreferences.getString("role", ""), sharedPreferences.getLong("userId", 1));
