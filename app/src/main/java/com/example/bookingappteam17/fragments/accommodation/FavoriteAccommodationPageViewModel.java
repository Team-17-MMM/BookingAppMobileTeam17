...
public class FavoriteAccommodationPageViewModel extends ViewModel {
    ...
    public void loadAccommodations(String username, String role, Long id) {
        Call<HashSet<AccommodationCardRDTO>> call = ClientUtils.accommodationService.getFavoriteAccommodationsCards(id);
